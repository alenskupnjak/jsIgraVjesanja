class Podaci {
  ...
  async jednarijec() {
    ...
    if (
      responseData.word.length > 13 ||
      responseData.word.includes('-') ||
      responseData.word.includes(' ')
    ) {
    ...
    const nounURL = `https://api.wordnik.com/v4/word.json/${responseData.word.trim(
      ''
  ...
  prijevod(datatext, calback) {
    ...
    xhr.setRequestHeader(
      'x-rapidapi-key',
      '9f578f1b85msh7435be72f29f5dcp1c7dadjsn5324bbe2c60d'
    );
